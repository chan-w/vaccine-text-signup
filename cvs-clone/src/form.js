  ...
  return (
    ...
    <style>
      ...
      <div className="Page 1">
        ...
        <input type="text" id="positive_test"/>
      ...
      <div className="Page 2">
        ...
        <input type="text" id="signup_type"/>
      </div>
      <div className="Page 3">
        <h2>5. Where do you want to be vaccinated?</h2>
        <input type="text" id="vaccine_site"/>
      </div>
      ...
      <div className="Page 6">
        ...
        <input type="text" id="vaccine_date"/>
      </div>
      ...
      <Link to= "/success" style={{ textDecoration: "none" }}><button id="submit">Submit</button></Link>
    </div>
  );
}
